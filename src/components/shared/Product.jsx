...
import { addProductsToCartServer } from '../../store/cart';
import { ADD_PRODUCT_TO_CART } from '../../store/cart/cartActionTypes';
        ...
        return (
            <div className={`product product--layout--${layout}`}>
                <div className="product__content">
                    <ProductGallery layout={layout} images={product.images} path={apiUrlImageProduct} tags={product.tags}/>
                    ...
                    <div className="product__info">
                        ...
                        <div className="product__description">
                            ...
                            <span dangerouslySetInnerHTML={{__html:product.product_description}} />
                        </div>
                            ...
                            <div className="form-group product__option">
                                ...
                                <div className="product__actions">
                                    ...
                                    <div className="product__actions-item product__actions-item--addtocart">
                                        ...
                                        /> :
                                        <AsyncAction
                                            action={() => addProductsToCartServer(ADD_PRODUCT_TO_CART, product.slug, quantity)}
                                            render={({ run, loading }) => (
                                                <button
                                                    type="button"
                                                    onClick={run}
...
const mapStateToProps = (state) => {
    return {
        ...
        // success: state.products.successCart,
        // error: state.products.errorCart
    };
};
...
const mapDispatchToProps={
    ...
    addProductsToCartServer,
    // : (id) => {dispatch(addProductsToCartAction(ADD_PRODUCT_TO_CART, id))}
};
