...
class ProductGallery extends Component {
    ...
    openPhotoswipe(index) {
        const { images, locale, path } = this.props;
        const { direction } = languages[locale];
    ...
    render() {
        const { layout, images, path , tags } = this.props;
        const { currentIndex } = this.state;
            ...
            return (
                ...
                >
                    <div className="product-image__body">
                        {/* <img className="product-image__img product-gallery__carousel-image" src={path + image} alt="" /> */}
                        <img className="product-image__img product-gallery__carousel-image" src={path + image} alt="" />
                    </div>
                </button>
            );
