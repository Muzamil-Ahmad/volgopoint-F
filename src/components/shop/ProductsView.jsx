...
function ProductsView(props) {
    ...
    const productsListItems = productsList.items && productsList.items.map((product,key) => (
        <div key={key} className="products-list__item">
    ...
    let content;
    let length=productsListItems?productsListItems.length:0
