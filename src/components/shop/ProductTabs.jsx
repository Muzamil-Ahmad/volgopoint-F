...
import ProductTabSpecification from './ProductSpecification';
...
class ProductTabs extends Component {
    ...
    render() {
        ...
        const { withSidebar, product,reviews } = this.props;
        const classes = classNames('product-tabs', {
            'product-tabs--layout--sidebar': withSidebar,
        });

        const tabs = [
            { key: 'description', title: 'Description', content: <ProductTabDescription data={this.props} /> },
            { key: 'specification', title: 'Specification', content: <ProductTabSpecification data={this.props} /> },
            { key: 'reviews', title: 'Reviews', content: <ProductTabReviews reviews={reviews} /> },
        ];
