                ...
                <div className="site__body">
                    <Switch>
                        ...
                        */}
                        ...
                        <PrivateRoute exact path="/shop/checkout" component={PageCheckout} />
                        <PrivateRoute exact path="/shop/checkout/success" component={ShopPageOrderSuccess} />
                        ...
                        */}
                        ...
                        // Account
                        */}
                        <PublicRoute exact path="/account/login" component={AccountPageLogin} />
...
function PrivateRoute({ component, ...rest }) {
    var isAuthenticated = localStorage.getItem("user_token") ? true : false;
    return ( <>
            {
            isAuthenticated ? ( <
                Route {...rest }
