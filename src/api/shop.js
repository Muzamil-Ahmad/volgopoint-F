...
const shopApi = {
     ...
     */
    getCategoryBySlugImplement: async (slug, options = {}) => {
        try {
            const data =  await axios.post(apiUrl + "buyer/getCategoryBySlugImplement?slug="+slug);
     ...
     * @return {Promise<object>}
     */
    getProductBySlugImplement: async (slug) => {
        try {
            const data = await axios.post(apiUrl + `buyer/getProductBySlug/${slug}`);
            return data.data.data;
          } catch (error) {
              return error;
          }
     ...
     * @return {Promise<Array<object>>}
     */
    getRelatedProductsImplement: async (slug, options = {}) => {
      try {
          const data =  await axios.post(apiUrl + "buyer/relatedProducts",options);
          return data.data.data;
        } catch (error) {
          if (error.response.status === 401) {
            return error; 
     ...
     * @return {Promise<object>}
     */
    getProductsListImplement:  async (options = {}, filters = {}) => {
      // console.log("filters in getkdkdk",filters);
      // console.log("filters in opion",options)
        try {
            const data =  axios.post(apiUrl + "buyer/productsList?page="+options.page+"&limit="+options.limit+"&sort="+options.sort+"&filter_category="+filters.category+"&filter_price="+filters.price+"&filters_brand="+filters.brand);
             return data;
          } catch (error) {
              return error;
          }
     ...
     * @return {Promise<Array<object>>}
     */
    getLatestProductsImplement: async (options = {}) => {
        try {
            const data = await axios.post(apiUrl + "buyer/latestProducts",options);
     ...
     * @return {Promise<Array<object>>}
     */
    getTopRatedProductsImplement: async (options = {}) => {
        try {
            const data =  await axios.post(apiUrl + "buyer/topRatedProducts",options);
            return data.data.data;
          } catch (error) {
            if (error.response.status === 401) {
              return error; 
     ...
     * @return {Promise<Array<object>>}
     */
    getDiscountedProductsImplement: async (options = {}) => {
        try {
            const data =  await axios.post(apiUrl + "buyer/discountedProducts",options);
            return data.data.data;
          } catch (error) {
            if (error.response.status === 401) {
              return error; 
     ...
     * @return {Promise<Array<object>>}
     */
    getPopularProductsImplement: async (options = {},filters = {}) => {
        try {
        console.log('actions in shop.js', options)
        console.log('filters in shop.js', filters)
